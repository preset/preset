...
import { useLinks } from '@/logic/next-and-previous-links'

const { hasLinks, prev, next } = useLinks()
</script>
...
<template>
  <div v-if="hasLinks">
    <div class="flex border-t border-$docs-bc pt-6 justify-between items-center">
