...
container.bind<HandlerContract>(Binding.Handler).to(EditHandler).whenTargetNamed(Name.Handler.Edit);
container.bind<HandlerContract>(Binding.Handler).to(GroupHandler).whenTargetNamed(Name.Handler.Group);
